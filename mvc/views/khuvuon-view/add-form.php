...
<div class="grid_10">
    <div class="box round first grid">
       <div class="block copyblock"> 
         <form action="admin/add/khuvuon" method="post">
            <table class="form">					
                <tr>
                	<td>
                ...
                <tr>
                	<td>
                		<input type="text" placeholder="Tên khu vườn" name="Ten_khuvuon">
                	</td>
                </tr>
                <tr>
                	<td>
                		<input type="text" placeholder="Địa chỉ chi tiết" name="Diachi">
                	</td>
                </tr>
                <tr>
                	<td>
